...
class OtpPageCustomer extends StatefulWidget {
  const OtpPageCustomer({super.key, this.email});
  final String? email;

  @override
  State<OtpPageCustomer> createState() => _OtpPageCustomerState();
}
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){
                          Get.offAll(() => const SignInCustomer());
                        },
